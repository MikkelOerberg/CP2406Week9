package ProgrammingExercises.Exercise10;
...
public class JavaJuniorCollege extends JFrame implements ActionListener
{
    ...
    JMenu menu4 = new JMenu("Clubs");
    JMenuItem exit = new JMenuItem("Exit");
    JMenuItem east = new JMenuItem("Australia");
    JMenuItem south = new JMenuItem("Singapore");
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(source == exit)
            ...
            text = "Singapore Campus is in the heart of Singapore";
        else if(source == east)
            text = "Australia Campus is in Townsville";
